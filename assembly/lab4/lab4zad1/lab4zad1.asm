...
_DATA SEGMENT
	...
	zmB	DD	2	; argument B
	zmE	DD	2	; pomocnicza zmienna do przechowania wartosci B
	...
	zmD	DD	4	; argument D
	wzor	DB	0Dh,0Ah,"Funkcja f(A,B,C,D) = (%ld+%ld)*(%ld+%ld) = %ld",0  ;%ld oznacza formatowanie w formacie dziesiêtnym
	ALIGN	4
