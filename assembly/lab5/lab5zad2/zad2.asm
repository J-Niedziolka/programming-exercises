...
_DATA SEGMENT
	...
	komunikat1	DB	"Pierwsza liczba jest mniejsza",13,10,0  
	ALIGN	4
	rozmiarKomunikat1	DD	$ - komunikat1
	komunikat2	DB	"Liczby s¹ równe",13,10,0
	ALIGN	4
	rozmiarKomunikat2	DD	$ - komunikat2
	komunikat3	DB	"Pierwsza liczba jest wiêksza",13,10,0
	ALIGN	4
	rozmiarKomunikat3	DD	$ - komunikat2
	ALIGN	4
