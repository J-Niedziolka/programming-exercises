...
_DATA SEGMENT
	...
	komunikatLiczba	DB	"Wylosowana liczba: %ld",0  ;%ld oznacza formatowanie w formacie dziesiêtnym
	ALIGN	4
	...
	komunikat1	DB	"Niestety nie trafi³eœ! Podaj mniejsz¹ liczbê!",13,10,0  
	ALIGN	4
	rozmiarKomunikat1	DD	$ - komunikat1
	komunikat2	DB	"Jesteœ zwyciêzc¹! Trafi³eœ za %ld razem!",0;,13,10,0
	ALIGN	4
	rozmiarKomunikat2	DD	$ - komunikat2
	komunikat3	DB	"Niestety nie trafi³eœ! Podaj wiêksz¹ liczbê!",13,10,0
	ALIGN	4
	rozmiarKomunikat3	DD	$ - komunikat3
	N	DD	?	; liczba prób
...
;--- przekszta³cenie A
	...
	etykieta3:
	;--- wyœwietlenie komunikatu 3 ---------
	push	OFFSET komunikat3
	push	OFFSET komunikat3
	call	CharToOemA	; konwersja polskich znaków
	
	push	OFFSET komunikat3
	call lstrlenA
	mov rozmiarKomunikat3,eax
	
	push	0 		; rezerwa, musi byæ zero
	push	OFFSET rout 	; wskaŸnik na faktyczn¹ liczbê wyprowadzonych znaków 
	push	rozmiarKomunikat3		; liczba znaków
	push	OFFSET komunikat3 	; wskaŸnik na tekst
 	push	hout		; deskryptor buforu konsoli
	call	WriteConsoleA	; wywo³anie funkcji WriteConsoleA
