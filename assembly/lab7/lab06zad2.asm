...
_DATA SEGMENT
	...
	zmD	DD	4	; argument D
	wzor	DB	0Dh,0Ah,"Funkcja f(A,B,C,D) = ...... = %ld",0  ;%ld oznacza formatowanie w formacie dziesiêtnym
	ALIGN	4
...
;--- wyœwietlenie ---------
    invoke 	WriteConsoleA, hout, OFFSET naglow,rozmN,OFFSET rout,0 ;przyk³ad u¿ycia invoke
;--- zaproszenie A ---------
	push	OFFSET zaprA
	push	OFFSET zaprA
	call	CharToOemA	; konwersja polskich znaków
