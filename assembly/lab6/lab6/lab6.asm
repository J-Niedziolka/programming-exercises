...
_DATA SEGMENT
        ...
        ;D:\ksiazki\UPH\Programowanie Niskopoziomowe\lab6


        cname BYTE "/Grupa2",0
        push cname
        cfname BYTE "D:/ksiazki/UPH/Programowanie Niskopoziomowe/Grupa2",0
        buffor BYTE 255 dup(0)
        push buffor
        ffname BYTE "D:/ksiazki/UPH/Programowanie Niskopoziomowe/lab6file.dot",0
        zm1 DWORD 10
        

        ;operacjen na lancuchazh znakow
